...
> **버전 (Version):** `v3.3.0 (Time Blocks Multi-Window 3-Tier Release)`  
> **최종 갱신일시:** 2026-09-11 22:50 (KST)  
...
- **주요 반영 내역:**
  ...
  4. **🏛️ 3-Tier 배포 체계 완결:** 연구실(`dev`) ➔ 실험실(`staging`, v3.2.1) ➔ 상용 실서버(`main`, v3.3.0) 무결점 배포.
