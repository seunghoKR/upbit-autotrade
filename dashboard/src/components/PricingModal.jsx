...
export default function PricingModal({ isOpen, onClose, currentTier = 'FREE_TRIAL', remainingDays = 7 }) {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: '2,000,000원',
      period: '월 구독',
      description: '12개 슬롯 풀그리드 개방 & 3대 전략(스캘핑/신고가/추세스윙) 하이브리드 운용',
      slots: '12개 슬롯 풀 가동 (3대 멀티 전략 완벽분산)',
      badge: '최고급 플랜 👑',
      badgeColor: 'bg-amber-500/20 text-amber-300 border-amber-500/30',
      features: [
        '12개 슬롯 전체 풀 가동 (스캘핑 1~8, 신고가 9~10, 스윙 11~12)',
        '3대 독립 전략 엔진 (초단타 / 당일 신고가 돌파 / 정배열 추세 스윙)',
        '다단(와이드) 트레일링 스탑 시스템 (+10% 대시세 홀딩)',
